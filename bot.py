...
MODEL_DATA = os.getenv('MODEL_DATA', 'stabilityai/stable-diffusion-xl-base-1.0')
...
NUM_INFERENCE_STEPS = int(os.getenv('NUM_INFERENCE_STEPS', '45'))
STRENTH = float(os.getenv('STRENTH', '0.75'))
GUIDANCE_SCALE = float(os.getenv('GUIDANCE_SCALE', '6'))
